...
?>
	...
	<div class="row">
		<div class="col-lg-12">
			<h2>Empezando</h2>
			<p class="text-justify">Descargue una <a href="/wallets">billetera</a>, descargue un minero adecuado para el algoritmo, encuentre un pool de mineria y disfrute...</p>
			<h2>Video tutorial de mineria</h2>
			<p class="text-justify">Vea en <a href="https://www.youtube.com/watch?v=961LFNZjLlY" target="_blank">Youtube</a>.</p>
			<hr>
		</div>
	</div>
	<div class="row">
		<div class="col-lg-6">
			<h2>Programas de mineria</h2>
			<dl>
				<dt>SHA256d</dt>
				<dd>Use cualquier minero SHA256d compatible con ASIC<hr></dd>
				<dt>Scrypt</dt>
				<dd>Use cualquier minero Scrypt compatible con ASIC<hr></dd>
				<dt>Myr-Groestl</dt>
				<dd>
					<ul>
						<li>sgminer para mineria GPU OpenCL
							<ul>
								<li><a href="https://bitcointalk.org/index.php?topic=632503.0" target="_blank">Discusion de BitcoinTalk (Ingles)</a></li>
								<li><a href="https://www.nicehash.com/index.jsp?p=software#amdgpu" target="_blank">Binarios de Windows</a></li>
								<li><a href="https://github.com/sgminer-dev/sgminer" target="_blank">Codigo fuente de Github</a></li>
							</ul>
							Linea de comandos sugerida
						...
						<li>ccminer for CUDA GPU mining
							<ul>
								<li><a href="https://bitcointalk.org/?topic=770064" target="_blank">Discusion de BitcoinTalk (Ingles)</a></li>
								<li><a href="https://github.com/tpruvot/ccminer/releases/latest" target="_blank">Binarios de Windows</a></li>
								<li><a href="https://github.com/tpruvot/ccminer" target="_blank">Codigo fuente de Github</a></li>
							</ul>
							Linea de comandos sugerida
						...
						<li>cpuminer-multi for CPU mining
							<ul>
								<li><a href="https://bitcointalk.org/?topic=841401" target="_blank">Discusion de BitcoinTalk (Ingles)</a></li>
								<li><a href="https://github.com/tpruvot/cpuminer-multi/releases/latest" target="_blank">Binarios de Windows</a></li>
								<li><a href="https://github.com/tpruvot/cpuminer-multi" target="_blank">Codigo fuente de Github</a></li>
							</ul>
							Linea de comandos sugerida
					...
					<ul>
						<li>cgminer for OpenCL GPU mining
							<ul>
								...
								<li><a href="https://github.com/reorder/cgminer_skein" target="_blank">Codigo fuente de Github</a></li>
							</ul>
							Linea de comandos sugerida
		...
		<div class="col-lg-6">
			...
			<h3>Piscina minera con fusion de mineria</h3>
			<dl>
				<dd>SHA256d</dd>
				<dt>
					<ul>
						<li><a href="http://www.zpool.ca/" target="_blank">zpool - Piscina multiple para mineros</a></li>
						<li><a href="https://www.multipool.us/" target="_blank">Piscina multiple</a></li>
					</ul>
					<hr>
				</dt>
				<dd>Scrypt</dd>
