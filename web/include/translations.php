...
function translate($text, $lang)
{
	...
	if($lang == 'es')
	{
		switch (clean($text))
		{
			...
			// wallets
			case clean("Latest version is 0.14.2.0, released October 20th 2017. See "):
				return "La ultima version es la 0.14.2.0, lanzada el 7 de Abril de 2016. Vea ";
		...
		else if($lang == 'eo')
	{
		switch (clean($text))
		{
			...
			// wallets
			case clean("Latest version is 0.14.2.0, released October 20th 2017. See "):
				return "La plej lasta versio estas 0.14.2.0, eldonita je la 7a Aprilo 2016. Vidu ";
			...
			case clean("Source Code (0.14.2.0)"):
				return "Fontkodo (0.14.2.0)";
	...
	else if($lang == 'zh')
	{
		switch (clean($text))
		{
			...
			// wallets
			case clean("Latest version is 0.14.2.0, released October 20th 2017. See "):
				return "最新版本0.14.2.0, 于2016年4月7号发布, 请查看";
	...
	else if($lang == 'el')
	{
		switch (clean($text))
		{
			...
			// wallets
			case clean("Latest version is 0.14.2.0, released October 20th 2017. See "):
				return "H Τελευταία έκδοση είναι η 0.14.2.0, που κυκλοφόρησε στις 7 Απρίλιος 2016. Δείτε ";
			case clean(" announcement &amp; upgrade notes."):
	...
	else if($lang == 'ru')
	{
		switch (clean($text))
		{
			...
			// wallets
			case clean("Latest version is 0.14.2.0, released October 20th 2017. See "):
				return "Последняя версия 0.14.2.0, выпущена 7ого апрель 2016. Смотрите";
			case clean(" announcement & upgrade notes."):
	...
	else if($lang == 'tl')
	{
		switch (clean($text))
		{
			...
			// wallets
			case clean("Latest version is 0.14.2.0, released October 20th 2017. See "):
				return "Pinakabagong Bersyon ay 0.14.2.0, inilimbag noong ika-7 ng Abril 2016. Tingnan ";
			case clean(" announcement &amp; upgrade notes."):
	...
	else if($lang == 'fr')
	{
		switch (clean($text))
		{
			...
			// wallets
			case clean("Latest version is 0.14.2.0, released October 20th 2017. See "):
				return "La dernière version est la 0.14.2.0, qui a été publiée le 7 Avril 2016. Voir ";
			case clean(" announcement &amp; upgrade notes."):
	...
	if($lang == 'id')
	{
		switch (clean($text))
		{
			...
			// wallets
			case clean("Latest version is 0.14.2.0, released October 20th 2017. See "):
				return "Versi terbaru adalahs 0.14.2.0, diluncurkan tanggal 7 April 2016. Lihat ";
	...
	else if($lang == 'bg')
	{
		switch (clean($text))
		{
			...
			// wallets
			case clean("Latest version is 0.14.2.0, released October 20th 2017. See "):
				return "Последната версия е 0.14.2.0, пусната на 7 април 2016г. Виж ";
			case clean(" announcement &amp; upgrade notes."):
	...
	else if($lang == 'de')
	{
		switch (clean($text))
		{
			...
			// wallets
			case clean("Latest version is 0.14.2.0, released October 20th 2017. See "):
				return " Die neueste Version ist 0.14.2.0, veröffentlicht am 06.07.2016. Siehe";
			case clean(" announcement & upgrade notes."):
	...
	else if($lang == 'it')
	{
		switch (clean($text))
		{
			...
			// wallets
			case clean("Latest version is 0.14.2.0, released October 20th 2017. See "):
				return "L’ultima versione 0.14.2.0 è stata rilasciata il 6 luglio 2016. Vedi:";
			case clean(" announcement & upgrade notes."):
	...
	else if($lang == 'ar')
	{
		switch (clean($text))
		{
			...
			// wallets
			case clean("Latest version is 0.14.2.0, released October 20th 2017. See "):
                                return "ﺎﺣﺪﺛ ﺎﺻﺩﺍﺭ 0.14.2.0,  ﺎﻟﺬﻳ ﺹﺩﺭ ﻒﻳ 6 /7/ 2016  , ﺎﻨﻇﺭ ";
			case clean(" announcement & upgrade notes."):
	...
	else if($lang == 'pl')
	{
		switch (clean($text))
		{
			...
			this change will stretch the emission curve out by a factor of 2x, to approximately 20 years."):
			 ...
			 // wallets
			case clean("Latest version is 0.14.2.0, released October 20th 2017. See "):
				return "Bieżąca wersja 0.14.2.0. Zobacz";
			case clean(" announcement & upgrade notes."):
	...
	else if($lang == 'pt')
	{
		switch (clean($text))
		{
			...
			case clean("In August 2015 Myriad hard-forked to allow merge-mining on its SHA256d and Scrypt algorithms in an effort to improve security and achieve
		        ...
		        // wallets
		        case clean("Latest version is 0.14.2.0, released October 20th 2017. See "):
             		      return "Última versão 0.14.2.0, lançada 6 de julho 2016. Clique aqui.";
             		case clean(" announcement & upgrade notes."):
	...
	else if($lang == 'ru')
	{
		switch (clean($text))
		{
			...
			// wallets
			case clean("Latest version is 0.14.2.0, released April 7th 2016. See "):
                                return "גרסה אחרונה 0.14.2.0 הונפקה ב 7-י יולי 2016. תראה";
			case clean(" announcement & upgrade notes."):
	...
	else if($lang == 'nl')
	{
			...
			// wallets
			case clean("Latest version is 0.14.2.0, released October 20th 2017. See "):
 				return "De nieuwste versie 0.14.2.0 op 7 juli 2016 uitgegeven. Zie ";
			case clean(" announcement & upgrade notes."):
        ...
        else if($lang == 'ro')
	{
		switch (clean($text))
		{
			...
			// wallets
			case clean("Latest version is 0.14.2.0, released October 20th 2017. See "):
 				return "Ultima versiune 0.14.2.0, a fost lansată pe 7 Iulie 2016. Priviți ";
			case clean(" announcement & upgrade notes."):
	...
	else if($lang == 'jp')
	{
		switch (clean($text))
		{
			...
			// wallets
			case clean("Latest version is 0.14.2.0, released October 20th 2017. See "):
				return "最新バージョン 0.14.2.0, 2016年4月7日リリース, バージョンをご確認ください";
			case clean(" announcement &amp; upgrade notes."):
